function results = run_EFSCF_V3(seq, res_path, bSaveImage)
...
% Which features to include  结构体赋值  t_features.getFeature 对应不同的函数
params.t_features = {  
...
% The scaling of the target size to get the search area
